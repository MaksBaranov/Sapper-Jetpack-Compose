...
import com.example.sappeur.ui.theme.cellFontSize
import com.example.sappeur.ui.theme.cellPadding
import com.example.sappeur.ui.theme.cellSize
...
@Composable
fun SapperGameScreen(viewModel: SapperGameViewModel) {
    ...
    if (gameState.gameStatus == GameStatus.OVER) {
        ...
        AlertDialog(
            onDismissRequest = { },
            title = { Text(text = stringResource(R.string.sapper_game_over)) },
            text = { Text(text = stringResource(R.string.sapper_hite_mine)) },
            confirmButton = {
                Button(onClick = {
                    viewModel.initGame(Difficulty.SMALL)
                }) {
                    Text(text = stringResource(R.string.sapper_new_game))
                }
            }
        )
    }
